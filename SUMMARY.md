...
* [Reference Architecture](README.md)
  ...
  * [Trust KIT](reference-architecture/trust-kit/README.md)
    ...
    * [Authentication](reference-architecture/trust-kit/authentication/README.md)
      * [Authentication M2M](reference-architecture/trust-kit/authentication/authentication.md)
      * [Authentication H2M](reference-architecture/trust-kit/authentication/authentication-h2m.md)
  ...
  * [Representation KIT](reference-architecture/representation-kit/README.md)
    * [Representation Register](reference-architecture/representation-kit/representation-register.md)
    * [Professional Qualification Register](reference-architecture/representation-kit/professional-qualification-register.md)
    * [Common Roles](reference-architecture/representation-kit/certified-roles.md)
  ...
  * [Boundary Management](reference-architecture/boundary-management/README.md)
    * [Digital Asset Boundaries](reference-architecture/boundary-management/digital-asset-boundaries.md)
    * [Physical Asset Boundaries](reference-architecture/boundary-management/physical-asset-boundaries.md)
    * [Legal Asset Boundaries](reference-architecture/boundary-management/legal-asset-boundaries.md)
