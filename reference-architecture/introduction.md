...
* Event-driven exchange of operational data within an instance:
  *
* Controlling the value of data:
  *
...
But innovation, competitiveness and making money depends on differentiation, specialization and the freedom to invent new offerings.
